object FrmCategoria: TFrmCategoria
  ...
  object FDDCategoria: TFDQuery
    AfterEdit = FDDCategoriaAfterEdit
    BeforePost = FDDCategoriaBeforePost
    OnNewRecord = FDDCategoriaNewRecord
    CachedUpdates = True
    Connection = DMConexao.FDConexao
    UpdateOptions.AssignedValues = [uvGeneratorName]
    UpdateOptions.GeneratorName = 'IN_CO_CATEGORIA'
    UpdateOptions.UpdateTableName = 'CATEGORIA'
    UpdateOptions.KeyFields = 'CO_CATEGORIA'
    UpdateOptions.AutoIncFields = 'CO_CATEGORIA'
    SQL.Strings = (
      'SELECT CO_CATEGORIA, '
      '       CO_EMPRESA, '
      '       NM_CATEGORIA, '
    ...
    object FDDCategoriaCO_CATEGORIA: TIntegerField
      FieldName = 'CO_CATEGORIA'
      Origin = 'CO_CATEGORIA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object FDDCategoriaCO_EMPRESA: TIntegerField
      FieldName = 'CO_EMPRESA'
      Origin = 'CO_EMPRESA'
      Required = True
    end
    object FDDCategoriaNM_CATEGORIA: TStringField
      FieldName = 'NM_CATEGORIA'
      Origin = 'NM_CATEGORIA'
      Required = True
      Size = 30
    end
    object FDDCategoriaCO_USUARIO: TIntegerField
      FieldName = 'CO_USUARIO'
      Origin = 'CO_USUARIO'
    end
    object FDDCategoriaDT_ALTERACAO: TSQLTimeStampField
      FieldName = 'DT_ALTERACAO'
      Origin = 'DT_ALTERACAO'
    end
  end
  object dtsCategoria: TDataSource
    DataSet = FDDCategoria
    OnStateChange = dtsCategoriaStateChange
    Left = 224
  end
end
